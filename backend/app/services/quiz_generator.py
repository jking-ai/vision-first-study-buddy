...
class QuizGenerator:
    ...
    async def generate(
        ...
        Args:
            ...
            device_id: The device identifier to scope material lookup.
        ...
        content_parts = await self._fetch_material_parts(material_ids, device_id)
    ...
    async def _fetch_material_parts(self, material_ids: list[str], device_id: str) -> list:
        ...
        for material_id in material_ids:
            blobs = await self.storage_client.get_material_blobs(material_id, device_id)
            if not blobs:
